...
const langGraphOptimal2 = require("../helper/langGraphOptimal2");
...
exports.executeLangGraphOptimal2 = async (req, res) => {
  try {
    const { command } = req.body;
    ...
    const result = await langGraphOptimal2.runLangGraphAgent(
      command.trim(),
      req.userId
    );
    ...
    helper.logErrorInFile("Error_log", {
      function: "executeLangGraphOptimal2",
      error: error.message,
      stack: error.stack,
    });
